...
For items 1 and 2 refer to the [priorities document](./priorities.md) items 1 and 2.
...
For the dashboard data contract that feeds the query-based generator, see [Dashboard Query Reference](./query_reference.md).
