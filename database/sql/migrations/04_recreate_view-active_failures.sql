-- Recreate active_failures so existing databases pick up query optimizations.
DROP VIEW IF EXISTS active_failures;
...
-- to repeat the same platform parsing rules.
